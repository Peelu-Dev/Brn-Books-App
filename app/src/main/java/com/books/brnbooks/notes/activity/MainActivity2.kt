...
import com.books.brnbooks.databinding.ActivityMain2Binding
import com.books.brnbooks.notes.adapter.SectionsPagerAdapter
...
class MainActivity2 : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.ib_search -> {
                val intent = Intent(this@MainActivity2, SearchActivity::class.java)
