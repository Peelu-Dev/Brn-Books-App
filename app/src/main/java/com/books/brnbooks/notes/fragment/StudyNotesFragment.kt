package com.books.brnbooks.notes.fragment
...
import com.books.brnbooks.databinding.FragmentStudyNotesBinding
import com.books.brnbooks.notes.activity.DetailNoteActivity
import com.books.brnbooks.notes.adapter.NoteAdapter
import com.books.brnbooks.notes.entity.Note
import com.books.brnbooks.notes.viewModel.NotesViewModel
...
class StudyNotesFragment : Fragment() {
    ...
    private fun initListener() {
        notesViewModel.setNotesByLabel("Book Notes")
    }
